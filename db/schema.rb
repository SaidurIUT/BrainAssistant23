...
ActiveRecord::Schema[7.1].define(version: 2026_03_18_154030) do
  ...
  create_table "knowledge_base_entries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_knowledge_base_entries_on_account_id"
  end
  ...
  add_foreign_key "knowledge_base_entries", "accounts"
